function [actMap1] = aMap(data,stat,endp,Fs,cmap, rect, movie_scrn, handles)
...
% Plot Map
if size(data,3) ~= 1
    handles.activeCamData.saveData = croppedAmap;
    cla(movie_scrn); 
    contourf(movie_scrn, croppedAmap,(endp-stat),'LineColor','k');
